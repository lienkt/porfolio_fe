...
const PORTFOLIO_CONTENT = {
  site: {
    ...
    name: "Lien KIM",
    role: "GenAI Developer | Software Developer",
  },
  navigation: {
    cv: "CV",
    linkedin: "LinkedIn",
  ...
  experience: {
    ...
    technologies: ["React", "Node.js", "Flutter", "Vue", "WordPress", "Java", "CakePHP"],
    companies: ["Sqwad - Paris", "Hello Pomelo - Paris", "FPT - HCM", "Axon Active - HCM", "IVC - HCM"],
  },
  projectsHeading: "My projects",
  projects: [
    {
      id: "project-0", note: "Note: Learning project", img: "assets/img/react_quiz_app.png",
      background_color: "yellow", github_link: "https://github.com/lienkt/react-quiz-app",
      live_link: "https://lienkt-react-quiz-app.netlify.app/", title: "React Quiz App",
    ...
    {
      id: "project-1", note: "Note: Learning project", img: "assets/img/issues_tracker.png",
      background_color: "orange", github_link: "https://github.com/lienkt/issues_tracker",
      live_link: "https://lienkt.github.io/issues_tracker/", title: "Issues Tracker",
      description: "A javascript app for creating, managing, and tracking issues with filtering and sorting. This application utilizes both fundamental and advanced JavaScript techniques along with Tailwind CSS to address some of the most common challenges in JavaScript development. It demonstrates my ability to create efficient, maintainable, and responsive solutions while applying best practices in modern web development.",
      tags: ["Javascript", "Tailwind"],
    },
    {
      id: "project-2", note: "Note: Personal project", img: "assets/img/portfolio.png",
      background_color: "green", github_link: "https://github.com/lienkt/porfolio_fe",
      live_link: "https://lienkim.info/", title: "Portfolio Website",
      description: "A web application fully developed using HTML5, CSS3, and JavaScript, showcasing my ability to build responsive websites with a modern, user-friendly interface that performs smoothly across all devices.",
      tags: ["Javascript", "HTML5", "CSS"],
    },
    {
      id: "project-3", note: "Note: Built at Sqwad", img: "assets/img/sqwad_dashboard.png",
      background_color: "pink", github_link: "", live_link: "", title: "Sqwad Dashboard",
    ...
    {
      id: "project-4", note: "Note: Personal project",
      img: "https://raw.githubusercontent.com/lienkt/QA-Form-Generator-FE/main/project.png",
      background_color: "blue", github_link: "https://github.com/lienkt/QA-Form-Generator-FE",
      live_link: "", title: "QA Form Generator",
      description: "This is an application that collects a client's requirements and questions and sends them to sellers before an order is created. After the client enters their requirements and questions, a PDF file is generated and automatically sent to the client and seller.",
