...
const PORTFOLIO_CONTENT = {
  ...
  projects: [
    {
      id: "project-0",
      note: "Note: Innovation challenge project",
      img: "assets/img/orange-opportunities.png",
      background_color: "orange",
      github_link: "https://github.com/lienkt/orange",
      live_link: "",
      title: "Opportunities Space Innovation — Orange Business",
      description:
        "An innovation project developed for Orange Business, exploring how technology and Generative AI can help identify and shape new business opportunities.",
      tags: ["Generative AI", "Innovation", "Business Intelligence"],
    },
    {
      id: "project-1",
      note: "Note: GenAI challenge project",
      ...
      description:
        "A Generative AI project created for the SNCB challenge, exploring how AI can support smarter and more helpful railway experiences.",
      tags: ["Generative AI", "Python", "LLMs"],
    },
    {
      id: "project-2",
      note: "Note: AI & Data project",
      ...
      title: "Belgian House Price Estimation",
      description:
        "Enter property details and location data to receive a fast, data-driven market estimate. The model uses geospatial and property attributes to generate a realistic price prediction.",
